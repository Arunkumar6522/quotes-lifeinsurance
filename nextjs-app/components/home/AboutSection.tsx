        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              {stats.map((s, i) => (
                <Animate key={s.label} delay={i * 0.08} direction="up">
                  <div className="rounded-2xl p-7 text-center transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
                    ...
                    <p className="text-4xl font-extrabold mb-1.5 gradient-text">{s.value}</p>
          ...
          <Animate direction="right">
            ...
            <p className="text-gray-500 leading-relaxed mb-4">
              Quotes Life Insurance — operated by <strong className="text-gray-700">DCW Financial Inc.</strong> — is a family-built, client-first brokerage led by Denesh Logeswaran and Lucia Medina. Founded in 1998.
            </p>
            <p className="text-gray-500 leading-relaxed mb-8">
              We operate as independent advisors contracted through <strong className="text-gray-700">Experior Financial Group Inc. (MGA)</strong>, giving us access to 20+ top Canadian carriers — so we always recommend what's right for <em>you</em>, not what pays us most.
            </p>
